<div class="col-md-12 content-left">
    ...
    <div class="form-group">
        ...
        <div class="col-sm-4">
            <?php echo CHtml::activeFileField($model, 'photo', array('class'=>'col-sm-12')); ?>
            <?php echo $form->error($model,'photo'); ?>
        </div>
        <div class="col-sm-4" style="min-height: 75px;">
            <?php if($model->photo) : ?>
                <?=$model->getPhoto(2);?>
            <?php endif; ?>
        </div>
    ...
    <div class="form-group">
        ...
        <div class="col-sm-4 ">
            <?php echo $form->radioButtonList($model, 'showOnSearch', array('Y'=>'Yes','N'=>'No'), array('class'=>''));?>
