<div class="wrap">
			...
			<div class="s-grid-left">
				<div class="cricket">
					...
					<div class="c-sports-main">
						...
						<div class="c-text">
							<h6>Bangalore</h6>
							<a class="power" href="single.html">214 foreman required</a>
					...
					<div class="s-grid-small">
						...
						<div class="sc-text">
							<h6>Chennai</h6>
							<a class="power" href="single.html">750 contract workers wanted</a>
					...
					<div class="s-grid-small">
						<div class="sc-text">
							<h6>Palakad</h6>
							<a class="power" href="single.html">300+ labours wanted</a>
					...
					<div class="s-grid-small">
						<div class="sc-text">
							<h6>Trichy</h6>
							<a class="power" href="single.html">14 Electrician / Plumber vaccancies</a>
	...
	<div class="col-md-4 side-bar">
		<?php $this->renderPartial('pages/_right'); ?>
	</div>
	<div class="clearfix"></div>
</div>